...
- **subagent-driven-development** - Fast iteration with three-stage review (spec compliance, code quality, QA/testing). Routes tasks to specialist agents when domain is specified.
